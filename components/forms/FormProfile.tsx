...
import {schemaProfile} from "@/lib/validations";
...
export const FormProfile = ({user}: FormProfileProps) => {
  ...
  const handleSubmit = async (values: z.infer<typeof schemaProfile>) => {
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        router.push(buildPath(ROUTES.PROFILE_BY_ID, {profileId: user._id}));
      } else {
